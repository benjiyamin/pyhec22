...
from pyhec22.geometry import Profile
...
class VerticalCurveTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.profile.create_pt(113600.00,  63.003)
        self.profile.create_pt(114712.97,  51.873,  800.0)
        self.profile.create_pt(117454.76,  99.854, 2360.0)
        self.profile.create_pt(119104.00,  52.026,  800.0)
        self.profile.create_pt(120633.36,  59.673,  800.0)
        self.profile.create_pt(122474.50, 114.907, 1700.0)
        self.profile.create_pt(124750.00, 108.081,  800.0)
        self.profile.create_pt(126341.51, 139.911, 2000.0)
        self.profile.create_pt(127829.35, 113.130,  800.0)
        self.profile.create_pt(131083.05, 103.369,  800.0)
        self.profile.create_pt(132155.02, 108.729, 1000.0)
        self.profile.create_pt(134842.88,  92.601,  800.0)
...
class UnsmoothTest(unittest.TestCase):
    ...
    def test_negative_unsmooth(self):
        ...
        expected = self.profile.slope(50.0)
